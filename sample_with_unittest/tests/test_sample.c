...
/* 테스트 함수들 */
void test_star_count_row_1(void) { TEST_ASSERT_EQUAL(1, get_star_count(1, 5)); }

void test_star_count_row_2(void) { TEST_ASSERT_EQUAL(3, get_star_count(2, 5)); }

void test_star_count_row_3(void) { TEST_ASSERT_EQUAL(5, get_star_count(3, 5)); }

void test_star_count_row_4(void) { TEST_ASSERT_EQUAL(7, get_star_count(4, 5)); }

void test_star_count_row_5(void) { TEST_ASSERT_EQUAL(9, get_star_count(5, 5)); }
