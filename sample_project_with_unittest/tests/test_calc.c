...
/* add 함수 테스트 */
void test_add_positive_numbers(void) { TEST_ASSERT_EQUAL(5, add(2, 3)); }

void test_add_with_zero(void) { TEST_ASSERT_EQUAL(0, add(0, 0)); }

void test_add_negative_numbers(void) { TEST_ASSERT_EQUAL(-1, add(-5, 4)); }

void test_add_large_numbers(void) { TEST_ASSERT_EQUAL(100, add(50, 50)); }
...
void test_subtract_same_numbers(void) { TEST_ASSERT_EQUAL(0, subtract(5, 5)); }
...
void test_multiply_with_zero(void) { TEST_ASSERT_EQUAL(0, multiply(0, 100)); }

void test_multiply_negative_numbers(void) {
  TEST_ASSERT_EQUAL(-12, multiply(-3, 4));
}

void test_multiply_same_numbers(void) { TEST_ASSERT_EQUAL(25, multiply(5, 5)); }
